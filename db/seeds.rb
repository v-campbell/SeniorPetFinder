...
pet1 = Pet.create!({name: 'Jim', breed: 'Labrador Retreiver', age: 11, sex: 'M', size: 'L', about: 'Loves lady dogs named Pam', adopted_by: demo_user.id})
...
pet4 = Pet.create({name: 'Angela', breed: 'Sphynx', age: 9, sex: 'F', size: 'XS', about: 'If you pray enough, you can change yourself into a cat person.', adopted_by: demo_user.id})
